...
// import 'package:eventder/constant/urls.dart';
// import 'package:eventder/controller/api_controller.dart';

// Future<EventsResponse?> getEvents(
//     {required BuildContext context, required Map<String, String>? body}) async {
//   var _response =
//       await apiCall(url: urlListEvents, context: context, body: body);
...
//   var _response =
//       await apiCall(url: urlListEvents + eventId, context: context, body: body);
//   if (_response!.statusCode == 200) {
//     var _data = json.decode(_response.body);
...
//   String? image;
//   Genres(
//       {this.id, this.name, this.slug, this.primary, this.images, this.image});
